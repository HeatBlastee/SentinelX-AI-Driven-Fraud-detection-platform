...
FastAPI backend for the SentinelX fraud detection platform: REST API, ML scoring models, graph intelligence, and the PostgreSQL data layer.
...
| --- | --- | --- |
| `DATABASE_URL` | — (required) | SQLAlchemy URL, e.g. `postgresql://user:pass@localhost:5432/SentinelX_db` |
