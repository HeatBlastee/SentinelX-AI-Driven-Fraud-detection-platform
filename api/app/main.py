...
async def lifespan(app: FastAPI):
    # Startup
    logger.info("Starting SentinelX Fraud Detection Platform...")
    init_db()
    ...
    # Shutdown
    logger.info("Shutting down SentinelX Fraud Detection Platform...")
...
async def root():
    return {
        "message": "SentinelX Fraud Detection Platform API",
        "version": settings.VERSION,
        "docs": "/docs",
    }
