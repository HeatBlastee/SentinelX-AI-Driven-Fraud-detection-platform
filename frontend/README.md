...
React analyst dashboard for the SentinelX fraud detection platform: live KPIs, fraud alerts, risk analysis, compliance posture, and an interactive fraud-ring graph.
