        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-xl bg-cyan-500/10 border border-cyan-500/20 SentinelX-glow">
                <Shield className="w-6 h-6 text-cyan-300" />
              </div>
              <div>
                <h1 className="text-xl font-bold text-cyan-300 SentinelX-text-glow">SentinelX</h1>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-3">
              <span className="SentinelX-chip px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-widest">
                Active
              </span>
              <div className="flex items-center gap-2 bg-slate-900/70 border border-slate-800 rounded-full px-3 py-1">
                ...
                <span className="text-sm font-semibold text-amber-300 SentinelX-mono">{riskIndex}</span>
              </div>
              <div className="hidden md:flex items-center gap-2 bg-slate-900/70 border border-slate-800 rounded-full px-3 py-1">
                ...
                <span className="text-sm font-semibold text-cyan-300 SentinelX-mono">
              ...
              <div className="relative" ref={profileRef}>
                ...
                {showProfile && (
                  <div className="absolute right-0 mt-3 w-48 bg-slate-950 border border-slate-800 rounded-xl shadow-xl p-3 z-50">
                    ...
                    <div className="text-sm text-white font-medium mt-1">SentinelX Analyst</div>
