  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="SentinelX-panel rounded-2xl p-6 border border-red-500/20">
        ...
        <div className="SentinelX-panel rounded-2xl p-6 border border-orange-500/20">
        ...
        <div className="SentinelX-panel rounded-2xl p-6 border border-yellow-500/20">
      ...
      <div className="SentinelX-panel rounded-2xl border border-slate-800/70 overflow-hidden">
            ...
            <tbody className="divide-y divide-slate-700">
              {highRiskProfiles.map((customer) => (
                <tr key={customer.id || customer.customer_id} className="hover:bg-slate-700/30 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="text-cyan-400 SentinelX-mono text-sm">{customer.customer_id}</span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
