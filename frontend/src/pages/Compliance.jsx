  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="SentinelX-panel rounded-2xl p-6 border border-green-500/20">
          <div className="flex items-center gap-3 mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {formattedFrameworks.map((framework) => (
          <div key={framework.id || framework.name} className="SentinelX-panel rounded-2xl p-6 border border-slate-800/70 hover:border-cyan-500/50 transition-all">
