...
const Dashboard = () => {
  ...
  const briefSummary = useMemo(() => {
    return [
      `SentinelX Command Brief · ${new Date().toLocaleString()}`,
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 xl:grid-cols-[1.6fr_1fr] gap-6 SentinelX-fade" style={{ animationDelay: '0.05s' }}>
        <div className="SentinelX-panel rounded-3xl p-6 border border-slate-800/70 relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-5">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                <p className="text-xs uppercase tracking-[0.24em] text-slate-500">SentinelX Command Center</p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="SentinelX-panel-soft rounded-2xl p-4">
        ...
        <div className="space-y-4">
          <BackendTest />
          <div className="SentinelX-panel-soft rounded-2xl p-5 border border-slate-800/70">
      ...
      {/* Metrics Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 SentinelX-fade" style={{ animationDelay: '0.1s' }}>
        <MetricCard
      ...
      {/* Charts Row */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 SentinelX-fade" style={{ animationDelay: '0.15s' }}>
        {/* Fraud Activity Chart */}
        <div className="SentinelX-panel rounded-2xl p-6 border border-slate-800/70">
      ...
      {/* Operations Pulse */}
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 SentinelX-fade" style={{ animationDelay: '0.2s' }}>
        <div className="SentinelX-panel rounded-2xl p-6 border border-slate-800/70">
      ...
      {showBrief && (
        ...
        >
          <div
            className="SentinelX-panel rounded-2xl p-6 border border-slate-800/70 max-w-2xl w-full"
      ...
      {showScenario && (
        ...
        >
          <div
            className="SentinelX-panel rounded-2xl p-6 border border-slate-800/70 max-w-3xl w-full"
            onClick={(event) => event.stopPropagation()}
          >
            <div className="flex items-center justify-between mb-4">
              <div>
              ...
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4">
                ...
                {scenarioResult ? (
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="SentinelX-panel-soft rounded-xl p-3 border border-slate-800/70">
                    ...
                    <div className="SentinelX-panel-soft rounded-xl p-3 border border-slate-800/70 col-span-2">
